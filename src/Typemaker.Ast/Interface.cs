...
namespace Typemaker.Ast
{
	...
	sealed class Interface : GenericDeclaration, IInterface
	{
		...
		public Interface(TypemakerParser.InterfaceContext context, IEnumerable<ITrivia> children) : base(ParseTreeFormatters.ExtractIdentifier(context.interface_type().IDENTIFIER()), context.declaration_block(), children)
		{
		}
	}
}
